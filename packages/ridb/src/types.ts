...
import type { BasePlugin, BaseStorage, Collection, MigrationsParameter, Schema, SchemaTypeRecord } from "@trust0/ridb-core";
 ...
 */
export type PendingRequests = Map<string, { resolve: (resp: any) => void; reject: (err: any) => void }>;
