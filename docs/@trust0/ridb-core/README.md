...
[Documentation](../../README.md) / @trust0/ridb-core

# @trust0/ridb-core

## Enumerations

- [Errors](enumerations/Errors.md)
...
- [CreateDoc](type-aliases/CreateDoc.md)
...
- [ExtractObject](type-aliases/ExtractObject.md)
- [ExtractProperty](type-aliases/ExtractProperty.md)
- [ExtractType](type-aliases/ExtractType.md)
- [FlagRequiredness](type-aliases/FlagRequiredness.md)
...
- [IsCreateOptional](type-aliases/IsCreateOptional.md)
- [IsNestedOptional](type-aliases/IsNestedOptional.md)
...
- [NInOperator](type-aliases/NInOperator.md)
- [NestedRequiredNames](type-aliases/NestedRequiredNames.md)
...
- [RequiredFieldNames](type-aliases/RequiredFieldNames.md)
...
- [is\_debug\_mode](functions/is_debug_mode.md)
